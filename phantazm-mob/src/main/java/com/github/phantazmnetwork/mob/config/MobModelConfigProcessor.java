...
public class MobModelConfigProcessor implements ConfigProcessor<MobModel<?, ?>> {
    ...
    private final MinestomDescriptorConfigProcessor minestomDescriptorConfigProcessor;
    ...
    public MobModelConfigProcessor(@NotNull MinestomDescriptorConfigProcessor minestomDescriptorConfigProcessor,
                                   @NotNull ConfigProcessor<Skill> skillConfigProcessor,
                                   @NotNull ConfigProcessor<ItemStack> itemStackConfigProcessor,
                                   @NotNull MiniMessage miniMessage) {
        this.minestomDescriptorConfigProcessor = Objects.requireNonNull(minestomDescriptorConfigProcessor, "minestomDescriptorConfigProcessor");
        this.skillConfigProcessor = Objects.requireNonNull(skillConfigProcessor, "skillConfigProcessor");
        this.itemStackConfigProcessor = Objects.requireNonNull(itemStackConfigProcessor, "itemStackConfigProcessor");
        this.miniMessage = Objects.requireNonNull(miniMessage, "miniMessage");
    }

    @Override
    public @NotNull MobModel<?, ?> dataFromElement(@NotNull ConfigElement element) throws ConfigProcessException {
        Pair<MinestomDescriptor, NeuralEntityFactory<? super MinestomDescriptor, ? extends NeuralEntity>> descriptorFactoryPair = minestomDescriptorConfigProcessor.descriptorFromElement(element.getElementOrThrow("descriptor"));
        ...
        return new MobModel<>(descriptorFactoryPair.first(), descriptorFactoryPair.second(), skills, displayName, equipment);
    }

    @Override
    public @NotNull ConfigElement elementFromData(@NotNull MobModel<?, ?> model) throws ConfigProcessException {
        ConfigElement descriptor = minestomDescriptorConfigProcessor.elementFromDescriptor(model.getDescriptor());
