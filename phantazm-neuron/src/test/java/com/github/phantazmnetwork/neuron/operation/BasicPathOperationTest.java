    ...
    class UpwardDestination {
        private static final Vec3I[] OPTIMAL_PATH =
                new Vec3I[] {Vec3I.ORIGIN, Vec3I.of(0, 1, 0), Vec3I.of(0, 2, 0), Vec3I.of(0, 3, 0), Vec3I.of(0, 4, 0),
                             Vec3I.of(0, 5, 0), Vec3I.of(0, 6, 0), Vec3I.of(0, 7, 0), Vec3I.of(0, 8, 0),
                             Vec3I.of(0, 9, 0), Vec3I.of(0, 10, 0)};
        ...
        class Unblocked {
            ...
            void upwardMovement() {
                assertPathMatches(OPTIMAL_PATH, PathOperation.State.SUCCEEDED,
                                  makeOperation(UPWARD_DESTINATION, Vec3I.ORIGIN, UPWARD_MOVEMENT,
                                                Calculator.SQUARED_DISTANCE, NO_SOLIDS
                                  )
                );
            }
