...
public final class TranslationKeys {
    ...
    public static final String GUI_MAPEDITOR_CREATE = "gui.mapeditor.create";
    ...
    public static final String GUI_MAPEDITOR_ORIGIN = "gui.mapeditor.origin";
    public static final String GUI_MAPEDITOR_DISPLAY_ITEM_NBT = "gui.mapeditor.display.item_nbt";
}
