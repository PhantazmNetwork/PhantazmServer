package com.github.phantazmnetwork.zombies.game.player.state.revive;
...
public class ReviveHandlerTest {
    ...
    public void testDeathSuggestsDeathState() {
        ...
        assertEquals(deathState, reviveHandler.getSuggestedState().get());
    }
    ...
    public void testReviveSuggestsAliveState() {
        ...
        assertTrue(reviveHandler.getSuggestedState().isPresent());
        assertEquals(aliveState, reviveHandler.getSuggestedState().get());
    }
