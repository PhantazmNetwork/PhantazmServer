...
public class ItemPowerupVisual implements PowerupVisual {
    ...
    public void tick(long time) {
        ...
        double heightMod = Math.sin((2 * Math.PI * time) / data.period) * data.amplitude;

        Pos pos = entity.getPosition();
        entity.teleport(new Pos(pos.x(), baseY + heightMod, pos.z()));
    }
    ...
    @DataObject
    public record Data(@NotNull ItemStack stack, double period, double amplitude) {
