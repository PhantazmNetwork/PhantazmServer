...
public class ZombiesPlayerStartReviveEvent implements ZombiesPlayerEvent {
    private final Player player;
    private final ZombiesPlayer zombiesPlayer;
    private final ZombiesPlayer reviveTarget;

    public ZombiesPlayerStartReviveEvent(@NotNull Player player, @NotNull ZombiesPlayer zombiesPlayer,
