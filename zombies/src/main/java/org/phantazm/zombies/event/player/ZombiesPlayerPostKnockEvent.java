...
public class ZombiesPlayerPostKnockEvent implements ZombiesPlayerEvent {
    private final Player player;
    private final ZombiesPlayer zombiesPlayer;

    public ZombiesPlayerPostKnockEvent(@NotNull Player player, @NotNull ZombiesPlayer zombiesPlayer) {
