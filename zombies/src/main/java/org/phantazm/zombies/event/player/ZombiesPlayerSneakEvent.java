...
public class ZombiesPlayerSneakEvent implements ZombiesPlayerEvent {
    private final Player player;
    private final ZombiesPlayer zombiesPlayer;

    public ZombiesPlayerSneakEvent(@NotNull Player player, @NotNull ZombiesPlayer zombiesPlayer) {
