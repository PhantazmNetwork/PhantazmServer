...
public class NonUpgradeablePerkLevelCreator implements PerkLevelCreator {
    ...
    @FactoryMethod
    public NonUpgradeablePerkLevelCreator(@NotNull @Child("equipment") PerkEquipmentCreator equipment,
    ...
    @DataObject
    public record Data(@NotNull @Description("The equipment controlling this perk's visuals") @ChildPath(
