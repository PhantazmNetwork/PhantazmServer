...
@Model("zombies.upgrade.validator.flag")
@Cache
public class FlagValidator implements ValidatorComponent {
    private final Data data;

    @FactoryMethod
    public FlagValidator(@NotNull Data data) {
