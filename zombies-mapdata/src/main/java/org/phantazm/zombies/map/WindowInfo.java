...
public record WindowInfo(
     ...
     */
    public WindowInfo {
        Objects.requireNonNull(frameRegion);
        Objects.requireNonNull(repairSound);
        Objects.requireNonNull(repairAllSound);
        Objects.requireNonNull(breakSound);
        Objects.requireNonNull(breakAllSound);
        Objects.requireNonNull(repairActions);
        Objects.requireNonNull(breakActions);
    }
